...
plot7cd = (p1  | p2) +
  patchwork::plot_annotation(subtitle = "Köferle Benchmark",    theme = theme(plot.subtitle = element_text(hjust = 0.5)))
 
full_plot =  wrap_elements(plot) / wrap_elements(plot7cd)
